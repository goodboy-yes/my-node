import{_ as a,r as e,o as i,c as l,a as n,b as d,d as c,e as t}from"./app-CtA61ec0.js";const r={},p=t(`<h1 id="docker" tabindex="-1"><a class="header-anchor" href="#docker"><span>Docker</span></a></h1><h2 id="使用情景" tabindex="-1"><a class="header-anchor" href="#使用情景"><span>使用情景</span></a></h2><p>在平时如果想在 Windows 使用安装 Linux 环境，没有云服务器的情况下大多数人这时会选择去用虚拟机安装一个 ubuntu 系统。不过安装虚拟机前，你得先去下载几个 G 的镜像，然后在 VMware 里配置一些参数，最后还要等待最少十几分钟的系统安装。等你安装完一个 ubuntu 系统，估计已经浪费了几个小时。</p><p>然而使用 Docker，你只需要几分钟！</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 拉取ubuntu镜像</span>
